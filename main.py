...
from entity_gym.environment import CategoricalAction, ObsFilter, CategoricalActionSpace, Action, Observation, SelectEntityAction, SelectEntityActionSpace
        ...
        for action_name, action_mask in obs.action_masks:
            ...
            for actor_id in action_mask.actors:
                if isinstance(action_def, CategoricalActionSpace):
                    ...
                    action[action_name].actions.append(
                        (actor_id, choice_id))
